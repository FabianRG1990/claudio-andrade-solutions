...
import { BubbleStream } from '@cas-ui-shared/components/bubble-stream/bubble-stream';
 ...
 * 2D ambiente bajo una capa superior con copy editorial, badge de capacidad
 * activa, CTA hacia los productos y card "próxima cohorte" en glass-shell.
 *
