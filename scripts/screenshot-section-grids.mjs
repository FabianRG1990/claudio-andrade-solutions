// Snapshot the two section grids that got background:#06091b applied.
...
for (const sel of ['.featured-products__grid', '.engagements__grid']) {
  ...
  if (!box) continue;
  const path = `${outDir}/grid-${sel.replace(/[.\s]/g, '_')}-${stamp}.png`;
